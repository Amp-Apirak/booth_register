...
### หน้าเปิดตัว Event Experience

หน้า `/` ใช้กราฟิกวงแหวนโฮโลแกรม CSS 3D พร้อมตั๋วดิจิทัลลอย แสงสะท้อน และเอฟเฟกต์ตอบสนองเมาส์ ในธีมม่วง–คราม–ไซแอนให้เข้ากับ Navigation และการ์ดของระบบ โดยดึงชื่อ โลโก้ วันเวลา และสถานที่จาก Settings เดิม ผู้ชมเลือกเข้าสู่เมนูหลักหรือลงทะเบียนได้โดยตรง พร้อมปุ่มพักเอฟเฟกต์ รองรับ `prefers-reduced-motion` และเลย์เอาต์มือถือ/แท็บเล็ต หลังเข้าสู่หน้าแรกสามารถกด **ชมหน้าเปิดตัวอีกครั้ง** ได้

พื้นหลังหน้าแรกและกรอบ Event มีแสงออโรรา เส้นแสงโค้ง ประกายลอย และลำแสงพาดผ่านที่เคลื่อนไหวในโทนเดียวกับระบบ ปุ่ม **พักเอฟเฟกต์** ควบคุมทั้งพื้นหลังและฉาก 3D พร้อมกัน ลดจำนวนประกายบนมือถือ และหยุดการเคลื่อนไหวเมื่อเปิด `prefers-reduced-motion`

หน้า `/register` ใช้พื้นหลังเคลื่อนไหวชุดเดียวกันในโหมดแสงนุ่ม โดยลดความสว่างตรงกลางเพื่อให้อ่านและกรอกฟอร์มสะดวก มีปุ่ม **พักพื้นหลัง** ที่ไม่เปลี่ยนข้อมูลในฟอร์ม และซ่อนพื้นหลัง/ปุ่มควบคุมในงานพิมพ์

รายละเอียดแนวคิดและการตรวจสอบอยู่ใน [Event Experience](docs/homepage-experience.md)
